...
@section('title') এমপ্লয়ী এডিট করুন @endsection
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('li_1') এমপ্লয়ী এডিট করুন @endslot
        @slot('title') এমপ্লয়ী এডিট করুন @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 col-12">
            <div class="card card-body">
                <form action="{{ route('employe.update', $user->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="ইউজারনাম">ইউজারনাম</label>
                                <input type="text" name="username" value="{{ $user->username }}" class="form-control" placeholder="ইউজারনাম">
                        ...
                        <div class="col-md-4">
                            <div class="form-group  mb-3">
                                ...
                                <input type="email" name="email" value="{{ $user->email }}" class="form-control" placeholder="ই-মেইল">
                        ...
                        <div class="col-md-4">
                            <div class="form-group  mb-3">
                                ...
                                <input type="text" name="name" value="{{ $user->name }}" class="form-control" placeholder="আপনার পুরো নাম">
                        ...
                        <div class="col-md-4">
                            <div class="form-group  mb-3">
                                ...
                                <input type="text" name="phone" value="{{ $user->phone }}" class="form-control" placeholder="আপনার মোবাইল নাম্বার">
