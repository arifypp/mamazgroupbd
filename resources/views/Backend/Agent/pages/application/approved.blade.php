...
@section('title') সকল অ্যাপ্লিকেশন  @endsection
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('li_1') সকল অ্যাপ্লিকেশন  @endslot
        @slot('title') সকল অ্যাপ্লিকেশন  @endslot
    @endcomponent
                ...
                <div class="card-body">
                    <table class="table-responsive table align-middle">
                        ...
                        <tbody>
                            ...
                            @if( $value->referrelID == Auth::user()->id && $value->status == 1)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $value->name }}</td>
                                ...
                                <td>
                                    <a href="{{ route('agent.application.show', $value->id) }}" class="text-success"><i class="mdi mdi-18px mdi-eye"></i></a>
...
function deleteConfirmation(id) {
        swal.fire({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url:  "{{url('/agent/application/delete')}}/" + id,
