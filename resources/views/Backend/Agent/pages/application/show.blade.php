               ...
               <table class="table table-responsive w-100 align-middle text-nowrap overflow-hidden">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-5">৳ {{ number_format( $booking[0]->bookingmoney , 0 , '.' , ',' ) }} BDT</td>
                        </tr>
                    </tbody>
               </table>
               <div class="row">
                   <div class="col-md-12 m-auto text-center mb-4 mt-3">
                       <a href="{{ route('agent.application') }}" class="btn btn-danger waves-effect btn-label waves-light">
                       <i class="bx bx-block label-icon"></i>
                           ক্যানসেল
                        </a>
                       @if( $application->status == 0 )
                       <a href="javascript:void(0)" id="approvecash" data-id-app="{{ $application->id }}" data-attr-url="{{ route('agent.application.update', $application->id) }}" class="btn btn-success waves-effect btn-label waves-light">
...
<script>
      ...
      $(document).on("click", '#approvecash', function(e){
        e.preventDefault();
          ...
          let applicationhref = $(this).attr('data-attr-url');
