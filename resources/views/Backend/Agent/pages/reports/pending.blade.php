...
@section('title') পেন্ডিং রিপোর্টস  @endsection
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('li_1') পেন্ডিং রিপোর্টস  @endslot
        @slot('title') পেন্ডিং রিপোর্টস  @endslot
    @endcomponent
                ...
                <div class="card-body">
                    <table class="table-responsive table align-middle">
                        ...
                        <tbody>
                            ...
                            @if( $value->refereluserid == Auth::user()->id && $value->status == 0)
                            <tr>
                                <td>{{ $i++ }}</td>
